...
/**
 * Tool definition for process_data
 */
export const processDataTool = {
  name: "process_data",
  description: "Process data using example service",
  inputSchema: {
    type: "object",
    properties: {
      input: {
...
/**
 * Implementation of the process_data tool
 *
 * MCP 도구 구현시 주의사항:
 ...
 */
export async function processData(args: any) {
  try {
    // 필수 파라미터 검증
